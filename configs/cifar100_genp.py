...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--exp', type=str, default='genp_lwf_5', help = 'experiment name')
    subparsers.add_argument('--note', type=str, default='', help = 'note for exp')
    subparsers.add_argument('--type', type=str, default='genp', help = 'prompt_type')
    # generator prompt parameters
    subparsers.add_argument('--latent_dim', type=int, default=200, help = 'prompt_type')
    subparsers.add_argument('--hidden_dim', type=int, default=2048, help = 'prompt_type')
    ...
    subparsers.add_argument('--lwf', type=bool, default=True, help = 'loss lwf')

    # subparsers.add_argument('--pertask', type=bool, default=True, help = 'loss lwf')