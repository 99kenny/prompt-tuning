...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--length', default=196,type=int, )
    ...
    subparsers.add_argument('--exp', type=str, default='ptchp_s', help = 'experiment name')
    subparsers.add_argument('--note', type=str, default='', help = 'note for exp')
    subparsers.add_argument('--type', type=str, default='ptchp_s', help = 'prompt_type')
    ...
    subparsers.add_argument('--alpha_tv_l2', type=float, default=2.5e-5, help = 'loss var l2')
    subparsers.add_argument('--alpha_l2', type=float, default=3e-8, help = 'loss l2')
